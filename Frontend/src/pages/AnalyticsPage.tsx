  ...
  return (
    <div className="p-6 pt-2 space-y-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        {/* AI Relevance Scores */}
        <div className="glass rounded-2xl p-6 border border-[#faedcd]/60 shadow-xl flex flex-col justify-center items-center text-center bg-white/40">
          ...
          <div className="mt-8 w-full bg-[#faedcd]/50 rounded-2xl h-4 overflow-hidden border border-[#faedcd]/60">
            <div 
              className="bg-[#d4a373] h-full transition-all duration-1000 rounded-2xl" 
