    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-start justify-between">
        <button
          ...
          className="flex items-center gap-2 text-[#d4a373] hover:text-[#b5835a] font-bold mb-4 bg-[#faedcd]/40 px-4 py-2 rounded-2xl border border-[#faedcd] transition-all cursor-pointer shadow-sm"
        >
          <ArrowLeft size={20} />
          Back to Leads
        </button>
      ...
      {/* Lead Info Card */}
      <div className="glass rounded-2xl p-8 border border-[#faedcd]/60 shadow-xl">
        <div className="flex items-start justify-between">
          <div>
      ...
      <div>
        ...
        {lead.callSessions.length === 0 ? (
          <div className="bg-[#faedcd]/15 rounded-2xl border border-[#faedcd]/60 p-8 text-center text-[#3d2b1f]/60 font-semibold shadow-inner">
          ...
          <div className="space-y-3">
            {lead.callSessions.map((session) => (
              <div
                key={session.id}
                className="bg-white/50 backdrop-blur-sm rounded-2xl border border-[#faedcd]/60 p-5 hover:shadow-premium-glow hover:border-[#d4a373]/40 transition-all cursor-pointer shadow-sm"
              >
                <div className="flex items-start justify-between">
                  <div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {lead.objections.map((objection) => (
              <div
                key={objection.id}
                className="bg-white/50 backdrop-blur-sm rounded-2xl border border-[#faedcd]/60 p-5 shadow-sm"
              >
                <div className="flex items-start justify-between">
      ...
      <div className="space-y-4">
        ...
        <textarea
          ...
          rows={4}
        />
        <button className="mt-2 px-6 py-2.5 bg-[#d4a373] text-white font-bold rounded-2xl hover:bg-[#b5835a] transition-all cursor-pointer shadow-sm active:scale-95 text-sm">
          Save Notes
        </button>
      </div>
    </div>
