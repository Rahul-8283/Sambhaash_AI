...
export const RMPage: React.FC = () => {
  ...
  return (
    <div className="p-6 pt-2 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-[#2d1e18] font-display flex items-center gap-3">
            RM Control Desk 
            <span className="text-[10px] font-black bg-rose-100 text-rose-700 px-3 py-1 rounded-2xl border border-rose-200 uppercase tracking-widest">
              Live Allocation
            </span>
          </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <motion.div
            ...
            className="bg-white/50 backdrop-blur-sm p-5 rounded-2xl border border-[#faedcd]/60 shadow-sm flex items-center justify-between hover:shadow-premium transition-all duration-200"
          >
            <div>
      ...
      {/* Controls */}
      <div className="glass rounded-2xl border border-[#faedcd]/60 shadow-xl p-5 flex flex-col md:flex-row md:items-center justify-between gap-4">
        {/* Search */}
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-white/70 border border-[#faedcd] rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#d4a373]/30 focus:border-[#d4a373] text-sm text-[#3d2b1f] font-medium placeholder-[#3d2b1f]/30"
          />
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-3 w-full lg:w-auto">
          ...
          <div className="overflow-x-auto no-scrollbar scroll-smooth p-1 bg-[#faedcd]/30 border border-[#faedcd]/60 rounded-2xl max-w-full">
            <div className="flex flex-nowrap gap-1">
              {[
                ...
                <button
                  ...
                  className={`px-3.5 py-1.5 rounded-2xl text-xs font-bold tracking-wide transition-all duration-200 cursor-pointer whitespace-nowrap ${
      ...
      {/* Leads Table */}
      <div className="glass rounded-2xl border border-[#faedcd]/60 shadow-xl overflow-hidden bg-white/40">
        {loading ? (
                ...
                {filteredLeads.map((lead) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Language */}
                      <td className="px-6 py-4">
                        <span className="text-xs font-bold bg-[#faedcd] text-[#3d2b1f] px-3 py-1 rounded-2xl border border-[#d4a373]/20">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="w-24 bg-[#faedcd] h-2 rounded-2xl overflow-hidden border border-[#faedcd]/85">
                            <div 
                              className="bg-[#d4a373] h-full rounded-2xl" 
                      ...
                      <td className="px-6 py-4">
                        {isAssigned ? (
                          ...
                          <span className="inline-flex items-center gap-1.5 text-xs font-bold text-amber-800 bg-amber-100/50 px-2.5 py-1 rounded-2xl border border-amber-200/50 animate-pulse">
                      ...
                      <td className="px-6 py-4">
                        {isConverted ? (
                          <span className="inline-flex items-center gap-1 text-xs font-bold text-emerald-800 bg-emerald-100/50 px-2.5 py-1 rounded-2xl border border-emerald-200/50">
                            <CheckCircle size={12} /> Converted
                          </span>
                        ) : (
                          <span className="inline-flex items-center gap-1 text-xs font-bold text-blue-800 bg-blue-100/50 px-2.5 py-1 rounded-2xl border border-blue-200/50">
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            ...
                            className="flex items-center gap-1 px-3 py-1.5 bg-[#faedcd] hover:bg-[#f5e3b8] text-[#3d2b1f] text-xs font-bold rounded-2xl border border-[#d4a373]/20 transition-all shadow-sm cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
                          >
                            <UserPlus size={14} />
                          ...
                          <button
                            ...
                            disabled={isConverted}
                            className="flex items-center gap-1 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-2xl shadow-md shadow-emerald-600/10 transition-all cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
                          >
                            <CheckCircle size={14} />
                            Mark Converted
                          </button>
        ...
        {showAssignModal && selectedLeadForAssign && (
          <div className="fixed inset-0 bg-[#3d2b1f]/40 backdrop-blur-md flex items-center justify-center z-50 p-4">
            <motion.div
              ...
              className="bg-white/95 backdrop-blur-md rounded-2xl p-6 shadow-2xl max-w-md w-full border border-[#faedcd] space-y-5"
            >
              <div>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-white/70 border border-[#faedcd] rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#d4a373]/30 focus:border-[#d4a373] text-[#3d2b1f] font-bold"
                >
              ...
              <div className="flex gap-3 justify-end pt-2">
                <button
                  ...
                  disabled={submitting}
                  className="px-4 py-2 bg-[#faedcd] hover:bg-[#f5e3b8] text-[#3d2b1f] font-bold rounded-2xl text-sm transition-all cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={submitting}
                  className="px-5 py-2 bg-[#d4a373] hover:bg-[#b5835a] text-white font-bold rounded-2xl text-sm transition-all shadow-lg shadow-[#d4a373]/20 cursor-pointer disabled:opacity-50"
                >
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 bg-white/70 border border-[#faedcd] rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#d4a373]/30 focus:border-[#d4a373] text-sm text-[#3d2b1f] font-semibold"
                />
              </div>
              ...
              <div className="flex gap-3 justify-end pt-2">
                ...
                <button
                  ...
                  disabled={submitting}
                  className="px-5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-2xl text-sm transition-all shadow-lg shadow-emerald-600/20 cursor-pointer disabled:opacity-50"
                >
